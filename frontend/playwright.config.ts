...
export default defineConfig({
 ...
 webServer:[
  {command:'uv run --all-extras uvicorn backend.main:app --host 127.0.0.1 --port 8000',cwd:'..',url:'http://127.0.0.1:8000/api/v1/health',timeout:120000,env:{OPENAI_API_KEY:''}},
